...
char	*argv[];
{
	...
	np5 = np4+npoints[4];
        np6 = np5+npoints[5];
	graph(cmd,x,y,
		x+npoints[0],y+npoints[0],
		x+npoints[0]+npoints[1],y+npoints[0]+npoints[1],
		x+npoints[0]+npoints[1]+npoints[2],
		y+npoints[0]+npoints[1]+npoints[2],
		x+npoints[0]+npoints[1]+npoints[2]+npoints[3],
		y+npoints[0]+npoints[1]+npoints[2]+npoints[3],
		x+np5,
		y+np5,
		x+np6,
		y+np6,
		x+np6+npoints[6],
		y+np6+npoints[6],
		x+np6+npoints[6]+npoints[7],
		y+np6+npoints[6]+npoints[7]
