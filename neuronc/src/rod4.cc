...
main(void)
{
 ...
 ggain2   = rise * 1.0;
 ggain3   = rise * 1.0;
 gcygain  = rise * .015 / cycgbuf * loopgain;
 pdegain  = rise * .5 / cycgbuf;
 condgain = rise * 2.5 * loopgain;
 gca      = rise * .887 / cabuf * loopgain;
 ...
 startfl = 1;
 for (i=0,j=20; i<2500; i++) {

  if (i == 1000) rhod += 20.0 * rhodgain;			/* */
