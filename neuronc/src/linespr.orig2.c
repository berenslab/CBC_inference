...
sp = s1 * .82;
	...
	/* These values are for a 1/(1+pow(r/blurrad,ppow)) point spread func */
...
ppow = 3.21;
//error = -.006, +.003;
	/* end values for a 1/(1+pow(r/blurrad,ppow)) point spread func */

	/* These valuse are for sum of Gaussian blur and scatter */
	/*  func in form of original line spread function: */
