...
*/
 ...
 pdebase = .02;
 kdgcyc = .010;
 cycg = 1.0956557175468; 
 cond = 1.00000022; 
 totcond = 20.0;
 ca   =  0.373243055454029; 
 cax  = 0.153206025273213; 
 cabuf  = .2;
 cycgbuf = .5;
 loopgain = .2;
 ...
 startfl = 1;
 plotinc = 20;
 for (i=0,j=plotinc; i<10000; i++) {

  if (i == 2000) rhod += 20.0 * rhodgain * factor;	/* */
