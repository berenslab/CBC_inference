...
double rclcac(chan *cpnt);	/* senses [Ca] in core */
double rt(chan *cpnt);
void varcopyu(void);
...
#define ca4r11 11  *r
   ...
   spnt[9].cond       = 0;
   spnt[9].trans  [0] = 10;
   spnt[9].trate  [0] = rclca;             /* function of time */
   spnt[9].ratemul[0] = ca4f10;
   spnt[9].rateo  [0] = 0;      /* arate */
   spnt[9].trans  [1] = 8;
   spnt[9].trate  [1] = rt;             /* function of time */
   spnt[9].ratemul[1] = ca4r9;
   spnt[9].rateo  [1] = 1;      /* brate */
 
   spnt[10].numtrans   = 2;
   spnt[10].cond       = 0;
   spnt[10].trans  [0] = 11;
   spnt[10].trate  [0] = rclca;             /* function of time */
   spnt[10].ratemul[0] = ca4f11;
   spnt[10].rateo  [0] = 0;      /* arate */
   spnt[10].trans  [1] = 9;
   spnt[10].trate  [1] = rt;             /* function of time */
   spnt[10].ratemul[1] = ca4r10;
   spnt[10].rateo  [1] = 1;      /* brate */
 
   spnt[11].numtrans   = 1;
   spnt[11].cond       = 1.0;
   spnt[11].trans  [0] = 10;
   spnt[11].trate  [0] = rt;             /* function of time */
   spnt[11].ratemul[0] = ca4r11;
   spnt[11].rateo  [0] = 1;      /* brate */
...
#define ca4r11 11  *r
   ...
   nparm = 1;                           /* make 1 set of params */
   nq = 1;				/* make 1 Q10 value */
   ch=makchantype(ClCa,2,nstate,nparm,nq,dbasetc);  /* make chan state info */
   ch->unitary = dclcasu;		/* 14.2 pS @22 makes 22 ps @ 35 deg */
   ch->ions->ionp[PCL]  = 1.0;		/* permeability to Cl- ions */
   ch->ions->ionp[PNA] = 0;			/* permeability to Na+ ions / perm K */
   ch->ions->ionp[PCA] = 0;			/* permeability to Ca++ ions /perm K */
   ...
   spnt[2].cond       = 0;
   spnt[2].trans  [0] = 3;
   spnt[2].trate  [0] = rclcac;             /* function of ca conc, time */
   spnt[2].ratemul[0] = ca4f3;
   spnt[2].rateo  [0] = 0;      /* arate */
   spnt[2].trans  [1] = 1;
   spnt[2].trate  [1] = rt;             /* function of time */
   ...
   spnt[3].cond       = 0;
   spnt[3].trans  [0] = 4;
   spnt[3].trate  [0] = rclcac;             /* function of time */
   spnt[3].ratemul[0] = ca4f4;
   spnt[3].rateo  [0] = 0;      /* arate */
   spnt[3].trans  [1] = 2;
   spnt[3].trate  [1] = rt;             /* function of time */
   ...
   spnt[4].cond       = 0;
   spnt[4].trans  [0] = 5;
   spnt[4].trate  [0] = rclcac;             /* function of time */
   spnt[4].ratemul[0] = ca4f5;
   spnt[4].rateo  [0] = 0;      /* arate */
   spnt[4].trans  [1] = 3;
   spnt[4].trate  [1] = rt;             /* function of time */
   ...
   spnt[5].cond       = 0;
   spnt[5].trans  [0] = 6;
   spnt[5].trate  [0] = rclcac;             /* function of time */
   spnt[5].ratemul[0] = ca4f6;
   spnt[5].rateo  [0] = 0;      /* arate */
   spnt[5].trans  [1] = 4;
   spnt[5].trate  [1] = rt;             /* function of time */
   ...
   spnt[6].cond       = 0;
   spnt[6].trans  [0] = 7;
   spnt[6].trate  [0] = rclcac;             /* function of time */
   spnt[6].ratemul[0] = ca4f7;
   spnt[6].rateo  [0] = 0;      /* arate */
   spnt[6].trans  [1] = 5;
   spnt[6].trate  [1] = rt;             /* function of time */
   ...
   spnt[7].cond       = 0;
   spnt[7].trans  [0] = 8;
   spnt[7].trate  [0] = rclcac;             /* function of time */
   spnt[7].ratemul[0] = ca4f8;
   spnt[7].rateo  [0] = 0;      /* arate */
   spnt[7].trans  [1] = 6;
   spnt[7].trate  [1] = rt;             /* function of time */
   ...
   spnt[8].cond       = 0;
   spnt[8].trans  [0] = 9;
   spnt[8].trate  [0] = rclcac;             /* function of time */
   spnt[8].ratemul[0] = ca4f9;
   spnt[8].rateo  [0] = 0;      /* arate */
   spnt[8].trans  [1] = 7;
   spnt[8].trate  [1] = rt;             /* function of time */
   ...
   spnt[9].cond       = 0;
   spnt[9].trans  [0] = 10;
   spnt[9].trate  [0] = rclcac;             /* function of time */
   spnt[9].ratemul[0] = ca4f10;
   spnt[9].rateo  [0] = 0;      /* arate */
   spnt[9].trans  [1] = 8;
   spnt[9].trate  [1] = rt;             /* function of time */
   ...
   spnt[10].cond       = 0;
   spnt[10].trans  [0] = 11;
   spnt[10].trate  [0] = rclcac;             /* function of time */
   spnt[10].ratemul[0] = ca4f11;
   spnt[10].rateo  [0] = 0;      /* arate */
   spnt[10].trans  [1] = 9;
   spnt[10].trate  [1] = rt;             /* function of time */
