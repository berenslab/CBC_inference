...
{ 
  ...
  // Local parameters.
  setptr("c_vst",        &c_vst);            c_vst           = -0.04;
  setptr("c_vrev",       &c_vrev);           c_vrev          = -0.05;
  setptr("c_rm",         &c_rm);             c_rm            = 1e+04;
  setptr("c_cm",         &c_cm);             c_cm            = 1e-06;
  setptr("c_ri",         &c_ri);             c_ri            = 132;
  setptr("l_gain",       &l_gain);           l_gain          = 1;
  setptr("cd_Kv",        &cd_Kv);            cd_Kv           = 0.001;
  setptr("cd_H_at",      &cd_H_at);          cd_H_at         = 0.001;
  setptr("cd_H_a",       &cd_H_a);           cd_H_a          = 0.001;
  setptr("cd_H_s",       &cd_H_s);           cd_H_s          = 0.001;
  setptr("cd_Ca_L",      &cd_Ca_L);          cd_Ca_L         = 0.005;
  setptr("cd_Ca_P",      &cd_Ca_P);          cd_Ca_P         = 1e-06;
  setptr("ca_PK",        &ca_PK);            ca_PK           = 1e-06;
  setptr("cd_ClCa",      &cd_ClCa);          cd_ClCa         = 0.001;
  setptr("c_L_offm",     &c_L_offm);         c_L_offm        = 0;
  setptr("c_L_taua",     &c_L_taua);         c_L_taua        = 1;
  setptr("c_Kv_offm",    &c_Kv_offm);        c_Kv_offm       = 0;
  setptr("c_Kv_taua",    &c_Kv_taua);        c_Kv_taua       = 1;
  setptr("c_rrp",        &c_rrp);            c_rrp           = 20;
}
...
{ 
  ...
  PRINTER(c_vst); fprintf(stderr, "	");
  PRINTER(c_vrev); fprintf(stderr, "	");
  PRINTER(c_rm); fprintf(stderr, "	");
  PRINTER(c_cm); fprintf(stderr, "	");
  PRINTER(c_ri); fprintf(stderr, "	");
  PRINTER(l_gain); fprintf(stderr, "	");
  PRINTER(cd_Kv); fprintf(stderr, "	");
  PRINTER(cd_H_at); fprintf(stderr, "	");
  PRINTER(cd_H_a); fprintf(stderr, "	");
  PRINTER(cd_H_s); fprintf(stderr, "	");
  PRINTER(cd_Ca_L); fprintf(stderr, "	");
  PRINTER(cd_Ca_P); fprintf(stderr, "	");
  PRINTER(ca_PK); fprintf(stderr, "	");
  PRINTER(cd_ClCa); fprintf(stderr, "	");
  PRINTER(c_L_offm); fprintf(stderr, "	");
  PRINTER(c_L_taua); fprintf(stderr, "	");
  PRINTER(c_Kv_offm); fprintf(stderr, "	");
  PRINTER(c_Kv_taua); fprintf(stderr, "	");
  PRINTER(c_rrp); fprintf(stderr, "	");
  PRINTER(set_dscaeg); fprintf(stderr, "	");
  PRINTER(cpl_axon); fprintf(stderr, "	");
