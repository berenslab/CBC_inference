...
double cone_x_hbp1 [] = {-13.49, 8.283999999999999, -1.9380000000000002, -8.828, 6.864};
double cone_y_hbp1 [] = {8.047, 6.153, 13.95, 3.1719999999999997, 14.44};
...
{ 
  ...
  // Local parameters.
  setptr("cd_Kv_d",      &cd_Kv_d);          cd_Kv_d         = 0.0004518;
  setptr("cd_Kv_pa",     &cd_Kv_pa);         cd_Kv_pa        = 0.0008863;
  setptr("cd_Kv_a",      &cd_Kv_a);          cd_Kv_a         = 0.0009818;
  setptr("cd_Kir",       &cd_Kir);           cd_Kir          = 0.001178;
  setptr("cd_H4_d",      &cd_H4_d);          cd_H4_d         = 0.0006285;
  setptr("cd_H4_s",      &cd_H4_s);          cd_H4_s         = 0.0004379;
  setptr("cd_H4_at",     &cd_H4_at);         cd_H4_at        = 0.0005587;
  setptr("cd_N",         &cd_N);             cd_N            = 0.01704;
  setptr("cd_L_s",       &cd_L_s);           cd_L_s          = 0.0001582;
  setptr("cd_L_at",      &cd_L_at);          cd_L_at         = 0.001207;
  setptr("cd_T_s",       &cd_T_s);           cd_T_s          = 0.001497;
  setptr("cd_T_at",      &cd_T_at);          cd_T_at         = 0.001422;
  setptr("cd_P_s",       &cd_P_s);           cd_P_s          = 3.767e-05;
  setptr("cd_P_at",      &cd_P_at);          cd_P_at         = 1.928e-05;
  setptr("ca_PK",        &ca_PK);            ca_PK           = 1.989e-05;
  setptr("c_L_off",      &c_L_off);          c_L_off         = -0.0004254;
  setptr("c_L_taua",     &c_L_taua);         c_L_taua        = 0.8753;
  setptr("c_T_off",      &c_T_off);          c_T_off         = 0.001129;
  setptr("c_T_taua",     &c_T_taua);         c_T_taua        = 0.9361;
  setptr("c_N_offm",     &c_N_offm);         c_N_offm        = 0.001618;
  setptr("c_N_offh",     &c_N_offh);         c_N_offh        = 0.00109;
  setptr("c_N_tau",      &c_N_tau);          c_N_tau         = 0.9765;
  setptr("c_Kir_off",    &c_Kir_off);        c_Kir_off       = -0.001958;
  setptr("c_Kv_taua",    &c_Kv_taua);        c_Kv_taua       = 2.116;
  setptr("c_Kv_off",     &c_Kv_off);         c_Kv_off        = -0.004791;
  setptr("r_tauc",       &r_tauc);           r_tauc          = 12.12;
  setptr("syn_cc",       &syn_cc);           syn_cc          = 0.000961;
  setptr("b_rrp",        &b_rrp);            b_rrp           = 5.665;
  setptr("bp_gain",      &bp_gain);          bp_gain         = 1.822;
  setptr("bp_vrev",      &bp_vrev);          bp_vrev         = -0.07531;
  setptr("bp_vst",       &bp_vst);           bp_vst          = -0.06;
  setptr("bp_rm",        &bp_rm);            bp_rm           = 2.233e+04;
  setptr("bp_ri",        &bp_ri);            bp_ri           = 132;
  setptr("bp_cm",        &bp_cm);            bp_cm           = 1.093e-06;
}
