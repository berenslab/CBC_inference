...
// Connect cones.
int contact_nodes_dbp1 [] = {1077, 980, 1190};
int contact_nodes_hbp1 [] = {};

// Cone positions
double cone_x_dbp1 [] = {2.415, 7.564, -2.039};
double cone_y_dbp1 [] = {6.732, -0.4648, -10.06};
...
{ 
  ...
  setptr("cd_H1_d",      &cd_H1_d);          cd_H1_d         = 0.001;
  setptr("cd_H1_s",      &cd_H1_s);          cd_H1_s         = 0.001;
  setptr("cd_H1_at",     &cd_H1_at);         cd_H1_at        = 0.003;
  setptr("cd_N",         &cd_N);             cd_N            = 0.02;
...
{ 
  ...
  if (make_dbp1 and !make_hbp1) {
    sprintf (savefile,"dbp1.eq");
  } else if (make_hbp1 and !make_dbp1) {
    sprintf (savefile,"hbp1.eq");
  } else {
    sprintf (savefile,"temp.eq");
  }
