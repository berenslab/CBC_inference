...
The simulation of the electrical stimulation in the paper uses the software [COMSOL Multiphysics](https://www.comsol.de/). The notebooks clearely indicate when a step requires COMSOL. If you don't have access to COMSOL, you can skip these steps and use the [precomputed data](step0a_download_data).
